...
func finished_attacking():
	if(player_in_range == true):
		fsm.change_state(attack_node, "enemy_chase")
	else:
		fsm.change_state(attack_node, "enemy_idle")
...
func _on_detection_area_body_entered(body):
	if body.is_in_group("Player"):
		...
		if fsm.current_state.name == "enemy_idle": 
			fsm.force_change_state("enemy_alert")
...
func _die():
	...
	fsm.force_change_state("enemy_death")
